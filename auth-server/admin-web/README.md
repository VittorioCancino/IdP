...
This will: start the local Postgres container, install dependencies, run Prisma migrations, seed the first admin user, and start the dev server at `http://localhost:3000`.
